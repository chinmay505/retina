...
Windows users should manually install Retina:
...
3. Add to PATH:
   - Add the full path to the `bin` directory to your system PATH environment variable
   - Or create a batch file in a directory that's already in your PATH:
   ```cmd
   @echo off
